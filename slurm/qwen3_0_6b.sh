#!/bin/bash
#SBATCH --job-name=finsent-qwen3-0.6b
...
# FinSent-CoT — Qwen3-0.6B full pipeline (SFT -> GRPO -> Export)

set -euo pipefail
export PYTHONUNBUFFERED=1

echo "=== Job $SLURM_JOB_ID — Qwen3-0.6B ==="
...
# Run full pipeline
python training/qwen3_0_6b.py --phase all --upload
