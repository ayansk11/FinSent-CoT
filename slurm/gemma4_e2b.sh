#!/bin/bash
#SBATCH --job-name=finsenti-gemma4-e2b
...
#SBATCH --output=logs/gemma4_e2b_%j.out
#SBATCH --error=logs/gemma4_e2b_%j.err
#SBATCH --mail-user=ayshaikh@iu.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --exclusive

# FinSenti - Gemma4-E2B full pipeline (SFT -> GRPO -> Export)

set -euo pipefail
export PYTHONUNBUFFERED=1

echo "=== Job $SLURM_JOB_ID - Gemma4-E2B ==="
...
# Run full pipeline
python training/gemma4_e2b.py --phase all --upload
