#!/bin/bash
#SBATCH --job-name=finsenti-qwen3.5-9b
...
#SBATCH --output=logs/qwen3_5_9b_%j.out
#SBATCH --error=logs/qwen3_5_9b_%j.err
#SBATCH --mail-user=ayshaikh@iu.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --exclusive

# FinSenti - Qwen3.5-9B full pipeline (SFT -> GRPO -> Export)

set -euo pipefail
export PYTHONUNBUFFERED=1

echo "=== Job $SLURM_JOB_ID - Qwen3.5-9B ==="
