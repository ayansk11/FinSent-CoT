#!/bin/bash
#SBATCH --job-name=finsent-deepseek-r1
...
# FinSent-CoT — DeepSeek-R1-1.5B full pipeline (SFT -> GRPO -> Export)

set -euo pipefail
export PYTHONUNBUFFERED=1

echo "=== Job $SLURM_JOB_ID — DeepSeek-R1-1.5B ==="
...
# Run full pipeline
python training/deepseek_r1_1_5b.py --phase all --upload
