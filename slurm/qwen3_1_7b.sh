#!/bin/bash
#SBATCH --job-name=finsenti-qwen3-1.7b
...
#SBATCH --output=logs/qwen3_1_7b_%j.out
#SBATCH --error=logs/qwen3_1_7b_%j.err
#SBATCH --mail-user=ayshaikh@iu.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --exclusive

# FinSenti - Qwen3-1.7B full pipeline (SFT -> GRPO -> Export)

set -euo pipefail
export PYTHONUNBUFFERED=1

echo "=== Job $SLURM_JOB_ID - Qwen3-1.7B ==="
...
# Run full pipeline
python training/qwen3_1_7b.py --phase all --upload
