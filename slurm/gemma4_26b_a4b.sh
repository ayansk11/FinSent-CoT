...
#SBATCH --output=logs/gemma4_26b_a4b_%j.out
#SBATCH --error=logs/gemma4_26b_a4b_%j.err
...
echo "=== Job $SLURM_JOB_ID — Gemma4-26B-A4B ==="
...
# Run full pipeline
python training/gemma4_26b_a4b.py --phase all --upload
