...
#SBATCH --output=logs/smollm_1_7b_%j.out
#SBATCH --error=logs/smollm_1_7b_%j.err
...
echo "=== Job $SLURM_JOB_ID - SmolLM-1.7B ==="
...
# pipe trips `set -o pipefail` -> exit 127, as happened in job 6900039).
_LIBCUDA_PATH=""
...
# Run full pipeline
python training/smollm_1_7b.py --phase all --upload
