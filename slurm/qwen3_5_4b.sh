#!/bin/bash
#SBATCH --job-name=finsent-qwen3.5-4b
...
#SBATCH --output=logs/qwen3_5_4b_%j.out
#SBATCH --error=logs/qwen3_5_4b_%j.err
#SBATCH --mail-user=ayshaikh@iu.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --exclusive

# FinSent-CoT — Qwen3.5-4B full pipeline (SFT -> GRPO -> Export)

set -euo pipefail
export PYTHONUNBUFFERED=1

echo "=== Job $SLURM_JOB_ID — Qwen3.5-4B ==="
...
# Run full pipeline
python training/qwen3_5_4b.py --phase all --upload
