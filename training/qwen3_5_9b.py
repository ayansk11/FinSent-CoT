"""
FinSent-CoT — Qwen3.5-9B: SFT -> GRPO -> Export -> Upload
...
Usage:
    python qwen3_5_9b.py --phase all          # Full pipeline
    python qwen3_5_9b.py --phase sft          # SFT only
    python qwen3_5_9b.py --phase grpo         # GRPO only
    python qwen3_5_9b.py --phase export       # Export only
"""
...
# HuggingFace repos
HF_FULL = "Ayansk11/FinSent-CoT-Qwen3.5-9B"
HF_REPOS = {
...
MLX_REPOS = {
    4: "Ayansk11/FinSent-CoT-Qwen3.5-9B-MLX-4bit",
    8: "Ayansk11/FinSent-CoT-Qwen3.5-9B-MLX-8bit",
}
