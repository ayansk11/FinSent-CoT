"""
FinSent-CoT — Qwen3.5-2B: SFT -> GRPO -> Export -> Upload
...
# HuggingFace repos
HF_FULL = "Ayansk11/FinSent-CoT-Qwen3.5-2B"
HF_REPOS = {
...
MLX_REPOS = {
    4: "Ayansk11/FinSent-CoT-Qwen3.5-2B-MLX-4bit",
    8: "Ayansk11/FinSent-CoT-Qwen3.5-2B-MLX-8bit",
}
...
def run_sft():
    ...
    _wandb_init_safe(project="FinSent-CoT", name=f"sft-{SHORT_NAME}-ep{SFT_EPOCHS}",
...
def run_grpo():
    ...
    _wandb_init_safe(project="FinSent-CoT", name=f"grpo-{SHORT_NAME}-max{GRPO_MAX_STEPS}-es",
