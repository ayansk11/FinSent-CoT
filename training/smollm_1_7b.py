"""
FinSenti — SmolLM-1.7B: SFT -> GRPO -> Export -> Upload
...
Usage:
    python smollm_1_7b.py --phase all          # Full pipeline
    python smollm_1_7b.py --phase sft          # SFT only
    python smollm_1_7b.py --phase grpo         # GRPO only
    python smollm_1_7b.py --phase export       # Export only
"""
...
MODEL_KEY = "smollm-1.7b"
BASE_MODEL = "unsloth/SmolLM-1.7B-Instruct"
SHORT_NAME = "SmolLM-1.7B"
MODEL_FAMILY = "smollm"
MAX_SEQ_LENGTH = 2048
TARGET_MODULES = [
...
# HuggingFace repos
HF_FULL = "Ayansk11/FinSenti-SmolLM-1.7B"
HF_GGUF = "Ayansk11/FinSenti-SmolLM-1.7B-GGUF"
QUANTIZATIONS = ["Q4_K_M", "Q5_K_M", "Q8_0"]
MLX_REPOS = {
    4: "Ayansk11/FinSenti-SmolLM-1.7B-MLX-4bit",
    8: "Ayansk11/FinSenti-SmolLM-1.7B-MLX-8bit",
}
