"""
FinSent-CoT — Qwen3-8B: SFT -> GRPO -> Export -> Upload
...
Usage:
    python qwen3_8b.py --phase all          # Full pipeline
    python qwen3_8b.py --phase sft          # SFT only
    python qwen3_8b.py --phase grpo         # GRPO only
    python qwen3_8b.py --phase export       # Export only
"""
...
MLX_REPOS = {
    4: "Ayansk11/FinSent-CoT-Qwen3-8B-MLX-4bit",
    8: "Ayansk11/FinSent-CoT-Qwen3-8B-MLX-8bit",
}
